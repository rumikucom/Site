  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        {/* Desktop Navbar */}
        <div className="hidden md:flex w-full items-center justify-between font-outfit font-bold text-foreground text-sm uppercase tracking-widest">
          {/* Left: Logo & Links */}
          <div className="flex items-center gap-8 lg:gap-12">
            <Link href="/" className="hover:opacity-80 transition-opacity flex-shrink-0 mr-4">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur-md border-b border-border shadow-lg py-6 px-6 flex flex-col gap-6 font-outfit font-bold text-foreground text-sm uppercase tracking-widest animate-fade-in-up">
          <nav className="flex flex-col gap-6">
            <Link href="#overview" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors">Overview</Link>
            <Link href="#about" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors">About</Link>
            <Link href="#ecosystem" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors">Ecosystem</Link>
            <Link href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors">Contact</Link>
          </nav>
