...
* **Frontend & UI:** Tailwind CSS, responsive components, high-contrast tactile interfaces.
* **Backend & Automation:** Scalable web platforms, modern API integrations, and streamlined workflow pipelines.